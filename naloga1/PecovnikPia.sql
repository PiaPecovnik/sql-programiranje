...
-- KORAK 5: V drugo tabelo dodajte manjkajoč stolpec na drugo mesto.
ALTER TABLE Intervencija
    ADD COLUMN IdGasilcaOperater INTEGER AFTER IdLokacije;
    
-- KORAK 6: Spremenite ime poljubnega stolpca v drugi tabeli.
ALTER TABLE Intervencija CHANGE IdLokacije IdIntervencije INTEGER NOT NULL;

-- Korak 7: Spremenite podatkovni tip poljubnega stolpca v drugi tabeli.
ALTER TABLE Intervencija
MODIFY COLUMN DatumKlica VARCHAR(50) NOT NULL;
